  ...
  const columns = [
    {
      ...
      render: (text) => (
        <div className="data-txnHash">
          <EyeIcon />
          <Link href={`/tx/${text}`} className="truncate">
            {text}
          </Link>
        </div>
      ),
    ...
    },
    {
      ...
      dataIndex: 'f',
      render: (f) => (
        <div className="data-from truncate">
          <Link className="data-from-link" href={`token/${query.token}?a=${f.a}`}>
            {f?.a}
          </Link>
        </div>
      ),
    },
    {
      ...
      render: (t) => (
        <div className="data-to">
          <RoundArrowIcon />
          <Link className="data-to-link truncate" href={`token/${query.token}?a=${t.a}`}>
            {t?.a}
          </Link>
        </div>
      ),
