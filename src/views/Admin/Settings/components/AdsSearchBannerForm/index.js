...
const AdsSearchBannerForm = ({ settings, dataAds }) => {
    ...
    const columns = [
        {
            ...
            width: '40%',
            editable: true,
            render: (text) => <img className='image-ads-preview' src={text} alt={text} />
        },
        {
            title: 'Url',
            dataIndex: 'url',
...
export default AdsSearchBannerForm