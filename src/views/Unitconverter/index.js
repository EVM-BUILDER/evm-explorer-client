        ...
        <div className="unitconverter-page">
            ...
            <div className="container">
                <p>
                    ...
                    smart contracts and {settings?.chain?.unit || 'Gwei'} for calculating gas prices. Use our Unit Converter to
                    easily convert between them! For more info on unit conversion, read our <p>knowledge base article.</p>
                </p>
                <div className="block">
                    <a href="#">[Reset]</a>
