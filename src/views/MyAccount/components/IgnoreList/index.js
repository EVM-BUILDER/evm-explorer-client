    ...
    return (
        <>
            ...
            >
                <IgnoreListTitle>
                    <p>
                        Hide selected tokens from being displayed in the Address Token Summary, Token Holdings and Watch List
                        pages. This is a private setting only applicable to you when logged-in with an {settings?.sitename}{' '}
                        account.
