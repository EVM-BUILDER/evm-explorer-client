                        ...
                        <Row>
                            ...
                            <Col xl={{ span: 12 }} sm={{ span: 12 }} xs={{ span: 24 }}>
                                <div>
                                    ...
                                    &emsp;
                                    <span>
                                        Subscribe to Newsletter <br /> {settings?.sitename}'s monthly newsletter brings you the
                                        latest features, analyses, trending stories, community contributions, job listings and
                                        giveaways !
                                    </span>
                                </div>
                            </Col>
