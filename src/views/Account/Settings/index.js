                  ...
                  <Row className="info-item">
                    ...
                    <Col xs={{ span: 24 }} md={{ span: 12 }}>
                      <Checkbox onChange={handleNewsletter}>
                        ...
                        Etherscan's monthly newsletter brings you the latest features, analyses, trending stories, community
                        contributions, job listings and giveaways !
                      </Checkbox>
                    </Col>
                  </Row>
                  <Row className="info-item">
                    ...
                    <Col xs={{ span: 24 }} md={{ span: 12 }}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            validator: (_, value) =>
                              value ? Promise.resolve() : Promise.reject(new Error('Please enter OLD Password!')),
                          },
                        ]}
                      >
                    ...
                    <Col xs={{ span: 24 }} md={{ span: 12 }}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            validator: (_, value) =>
                              value ? Promise.resolve() : Promise.reject(new Error('Please enter NEW Password!')),
                          },
                        ]}
                      >
                        <Input type="password" placeholder="Password" />
                    ...
                    <Col xs={{ span: 24 }} md={{ span: 12 }}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            validator: (_, value) =>
                              value ? Promise.resolve() : Promise.reject(new Error('Please enter Confirm Password!')),
                          },
                          ({ getFieldValue }) => ({
                            validator(_, value) {
                    ...
                    <Col xs={{ span: 24 }} md={{ span: 16 }} className="confirm-delete">
                      <Form.Item
                        ...
                        rules={[
                          {
                            validator: (_, value) =>
                              value ? Promise.resolve() : Promise.reject(new Error('Please check confirm checkbox!')),
                          },
                        ]}
                      >
                        <Checkbox onChange={handleNewsletter}>Confirm that I want to delete my account.</Checkbox>
                      </Form.Item>
                    </Col>
