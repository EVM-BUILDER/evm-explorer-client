...
const BoxInOut = ({ address, type = 'from', f, t, hideInOut, position = 'right' }) => {
  ...
  return (
    <BoxInOutStyled>
      ...
      <div className="box-right" style={position === 'left' ? { order: 2, marginRight: '6px' } : { order: 1, marginLeft: '6px' }}>
        {type === 'from' ? (
          <>
