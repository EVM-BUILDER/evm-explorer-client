export const GET_NATIVE_TOTAL_SUPPLY = 'GET_NATIVE_TOTAL_SUPPLY'
export const GET_NATIVE_TOTAL_SUPPLY_SUCCESS = 'GET_NATIVE_TOTAL_SUPPLY_SUCCESS'
...
export const getNativeTotalSupply = (params) => ({
    type: GET_NATIVE_TOTAL_SUPPLY,
    payload: { params },
})
export const getNativeTotalSupplySuccess = (data) => ({
    type: GET_NATIVE_TOTAL_SUPPLY_SUCCESS,
    payload: data,
})
