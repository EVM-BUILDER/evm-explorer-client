const actions = {
    ...
    GET_TOTAL_SUPPLY_SUCCESS: 'GET_TOTAL_SUPPLY_SUCCESS',
    GET_TOTAL_SUPPLY_ERROR: 'GET_TOTAL_SUPPLY_ERROR',
    ...
    getTotalSupply: (payload) => ({
        type: actions.GET_TOTAL_SUPPLY,
        payload,
    }),
    getTotalSupplySuccess: (payload) => ({
        type: actions.GET_TOTAL_SUPPLY_SUCCESS,
        payload,
    }),
    getTotalSupplyError: (payload) => ({
        type: actions.GET_TOTAL_SUPPLY_ERROR,
        payload,
    }),
